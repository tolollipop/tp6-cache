...
namespace lsf\cache\facade;

use think\Facade;
use lsf\cache\cache\Driver;
use lsf\cache\cache\TagSet;

/**
 * @see \lsf\cache\Cache
 * @package lsf\cache\facade
 * @mixin \lsf\cache\Cache
